...
import id.co.noz.usecaseview.view2.MaterialShowcaseView2;

public class ActivityDemo01 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUseCaseView() {
            new MaterialShowcaseView2.Builder(this)
                    .setTarget(button)
