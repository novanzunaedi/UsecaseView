...
import id.co.noz.usecaseview.view1.IDetachedListener;
...
public class MaterialShowcaseSequence implements IDetachedListener {
    ...
    public MaterialShowcaseSequence addSequenceItem(View targetView, String TittleText, String content, String dismissText) {

        MaterialShowcaseView sequenceItem = new MaterialShowcaseView.Builder(mActivity)
                .setTarget(targetView)
                .setTittleText(TittleText)
