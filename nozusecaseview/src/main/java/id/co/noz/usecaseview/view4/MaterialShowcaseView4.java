package id.co.noz.usecaseview.view4;
...
public class MaterialShowcaseView4 extends FrameLayout implements View.OnClickListener {
    ...
    List<IShowcaseListener4> mListeners = new ArrayList<>(); // external listeners who want to observe when we show and dismiss
    private UpdateOnGlobalLayout mLayoutListener;
    private IDetachedListener4 mDetachedListener;

    public MaterialShowcaseView4(Context context) {
        super(context);
        init();
    }

    public MaterialShowcaseView4(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MaterialShowcaseView4(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialShowcaseView4(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.showcase_content4, this, true);
    ...
    private void notifyOnDisplayed() {
        for (IShowcaseListener4 listener : mListeners) {
    ...
    public void addShowcaseListener(IShowcaseListener4 showcaseListener) {
    ...
    void setDetachedListener(IDetachedListener4 detachedListener) {
    ...
    public static class Builder {
        ...
        final MaterialShowcaseView4 showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new MaterialShowcaseView4(activity);
        }
        ...
        public Builder setListener(IShowcaseListener4 listener) {
        ...
        public MaterialShowcaseView4 build() {
        ...
        public MaterialShowcaseView4 show() {
            build().show(activity);
            return showcaseView;
        }
