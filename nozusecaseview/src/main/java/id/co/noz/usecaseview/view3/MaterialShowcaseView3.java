package id.co.noz.usecaseview.view3;
...
public class MaterialShowcaseView3 extends FrameLayout implements View.OnClickListener {
    ...
    List<IShowcaseListener3> mListeners = new ArrayList<>(); // external listeners who want to observe when we show and dismiss
    private UpdateOnGlobalLayout mLayoutListener;
    private IDetachedListener3 mDetachedListener;

    public MaterialShowcaseView3(Context context) {
        super(context);
        init();
    }

    public MaterialShowcaseView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MaterialShowcaseView3(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialShowcaseView3(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.showcase_content3, this, true);
    ...
    private void notifyOnDisplayed() {
        for (IShowcaseListener3 listener : mListeners) {
    ...
    public void addShowcaseListener(IShowcaseListener3 showcaseListener) {
    ...
    void setDetachedListener(IDetachedListener3 detachedListener) {
    ...
    public static class Builder {
        ...
        final MaterialShowcaseView3 showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new MaterialShowcaseView3(activity);
        }
        ...
        public Builder setListener(IShowcaseListener3 listener) {
        ...
        public MaterialShowcaseView3 build() {
        ...
        public MaterialShowcaseView3 show() {
            build().show(activity);
            return showcaseView;
        }
